package com.example.md06_clothes.Animation;
...
public class AnimationUtil {
    ...
    private static final int ANIMATION_DURUTION = 500;
    ...
    public static void translateAnimation(final ImageView viewAnimation, final View startView, View endView,
        ...
        ScaleAnimation transalateScaleAnimation = new ScaleAnimation(1.0f, 0.0f, 1.0f, 0.0f, toX, toY);
        transalateScaleAnimation.setStartOffset(animationDurution);
        transalateScaleAnimation.setDuration(ANIMATION_DURUTION);

        animationSet.addAnimation(startScaleAnimation);
        animationSet.addAnimation(translateAnimation);
        animationSet.addAnimation(transalateScaleAnimation);
